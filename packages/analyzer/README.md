...
Source code analysis for Ultimate.js. Parses TypeScript/TSX, extracts function signatures, classifies client/server/shared boundaries.
...
- `analyzeModule(file, parsed, isRouteFile, appDir)` — convert parsed AST to `ModuleAnalysis`
...
- **Types** — `ParserAdapter`, `ParsedModule`, `FunctionRecord`, `CallRecord`, `ImportRecord`, `ModuleAnalysis`, `ClassifiedFunction`
